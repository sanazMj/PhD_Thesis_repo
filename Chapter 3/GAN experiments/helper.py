...
def visualize_multi_colored_isos_edited(temp,name, epoch, id,views, lim, set_lim=False, save=False,
                     dir='/Ryerson/Projects/TumorGAN/GAN_3D/3D_chair_results/'):
    '''
...
def visualize_3d(temp, epoch=0, id=0, set_lim = False, lim=[240,240,160],conditions =[1,2],save=False,
                 dir='/Ryerson/Projects/TumorGAN/GAN_Simple_3D_shape_tumor/Results/'):
    ...
    if flag == 1 or flag == 2:
        ...
        if save:
            ...
            plt.show()
def visualize_tumor_3d(xline, yline, zline, epoch=0, id=0, set_lim = False, lim=[240,240,160], color='Greens',save=False,dir='/Ryerson/Projects/TumorGAN/GAN_Simple_3D_shape_tumor/Results/'):
    ax = plt.axes(projection='3d')
